  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4 footer-section1">
        <h1 className="text-4xl font-medium capitalize">Lets get 50% discount for <br /> all Product</h1>
        <p className="text-sm opacity-65">By claiming, you get a discount for one product from all available products.</p>
      ...
      <div className="flex gap-6">
        ...
        <div className="footer-section3">
          <ul className="flex flex-col gap-2 text-sm list-none">
            <p className="text-base  md:text-lg font-semibold">Customer Service</p>
            <li>
              <Link href="/work" className="opacity-75 hover:opacity-100">
                Troubleshooting
              </Link>
