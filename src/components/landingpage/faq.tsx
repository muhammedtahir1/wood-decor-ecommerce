...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We provide free delivery around 100 -200 km of Delhi, Mumbai, Chennai and Bengaluru cities. Please share your pin code and support team can assist you if we are operational in your city and state as we are expanding in other cities as well. Usual TAT for delivery is 10-15 days",
  },
  {
    qusetion: "How can we guarantee?",
    answer:
      "We use premium raw material in all our products. All the orders go through a rigid 3 level quality check at build, fabrication and delivery process. Your order is shipped after we receive a Yes on your prepared order pics and videos shared.",
  },
];
...
const Faq = () => {
  return (
    <div
      id="faq"
      className="mt-10 md:mt-20 mb-16 md:mb-20 px-6 flex flex-col justify-center items-center gap-3"
    >
