...
const GridDesign = () => {
  return (
    <section className="grid grid-cols-[200px_200px] md:grid-cols-[300px_300px_300px] grid-rows-[140px_140px] md:grid-rows-[180px_180px_180px] justify-center gap-4 my-10 h-[440px] mb-48 md:h-[440px] md:w-[600px] mx-auto scale-75 md:scale-90">
