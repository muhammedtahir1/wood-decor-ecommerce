...
const products: newProduct[] = [
  {
    ...
    description: "<h3>Isadora Lounge Sofa</h3><p></p><ul><li><p><strong>asdfasdf</strong></p><h3>asdfasdfasdf</h3><p>asdfasdfasdf</p><ul><li><p>asdfasdf</p></li><li><p>asldkfjasdf</p></li><li><p></p></li></ul></li></ul><p></p><p></p>",
    // prices: [
    //   {
    //     variant: "",
    //     price: 10
    ...
    image: "https://i.pinimg.com/564x/ec/ca/67/ecca673e7a5fd64099f30da4a88e2bb8.jpg",
    colors: ["red", "blue"],
    label: null,
    isFeatured: true,
    rating: 5,
